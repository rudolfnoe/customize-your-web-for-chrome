with (this) {
	...
	(function() {
		...
		var Utils = {
            ...
            throw new Error('Utils.logMessage not yet implemented');
			},
            ...
            throw new Error('Utils.logError not yet implemented');
          },

			logDebugMessage : function(messageString, debugPrefId) {
              throw new Error('Utils.logDebugMessage  not yet implemented');			
         },
